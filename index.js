 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`einrcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`einrcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var release = function(importance, cb) {
    ...
    return runsequence(
      ...
      // Run git push naveenedison $VERSION
      'release:push-tag',
      // Run npm publish
      'release:publish',
